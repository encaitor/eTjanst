...
<html>
    ...
    <body>
        <div class="header">
            <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
                ...
                <ul class="pure-menu-list">
                    <li class="pure-menu-item"><a href="adminTable.php" class="pure-menu-link">Admin</a></li>
        ...
        <div clas="banner">
            <h1 class="banner-head">Admin Profile</h1>
        </div>
            ...
            <div class="games-table pure-g">
                    ...
                    <div class="info-box pure-u-1 pure-u-md-16-24">
                        <div class="pofilePage">
                            <p><?php 
                                echo "<h3>Welcome! You are logged in as admin, " . $username . "</h3>"; 
                                ?></p>
